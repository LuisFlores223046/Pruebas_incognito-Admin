"""
Archivo: apps.py
Descripción: Configuración de la aplicación de historial para el sistema RYV Rentas.
             Define los parámetros de registro de la app historial dentro
             del proyecto Django.
Fecha: 2026-04-07
Versión: 1.0
"""
...
class HistorialConfig(AppConfig):
    """
    Configuración de la aplicación historial.
